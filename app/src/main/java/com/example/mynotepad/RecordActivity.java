...
import com.example.mynotepad.database.SQLiteHelper;
...
public class RecordActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        author=(EditText) findViewById(R.id.note_author);//内容的作者
            ...
            case R.id.note_save:
                ...
                if(id!=null){
                    ...
                    if(noteContent.length()>0){
                        if (mSQLiteHelper.updateData(id,noteAuthor,noteContent,DBUtils.getTime())){
                            showToast("修改成功");
                            setResult(2);
                            finish();
                        }else{
                    ...
                    //添加记录的功能
                    if(noteContent.length()>0){
                        if (mSQLiteHelper.insertData(noteAuthor,noteContent, DBUtils.getTime())){
                            showToast("保存成功");
                            setResult(2);
                            finish();
                        }else{
